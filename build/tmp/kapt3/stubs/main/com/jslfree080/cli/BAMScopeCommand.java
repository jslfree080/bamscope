...
@picocli.CommandLine.Command(name = "bamscope", version = {"bamscope 1.1.0"}, description = {"A command line tool (in Kotlin/JVM) for visualizing BAM alignments."})
public final class BAMScopeCommand implements java.lang.Runnable {
    ...
    @picocli.CommandLine.Option(names = {"-r", "--refPath"}, description = {"Path to a reference FASTA.  ex) path/to/x.fasta(.fa)"})
